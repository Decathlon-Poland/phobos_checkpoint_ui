...
export const REQUEST_ERROR_EVENTS_SEARCH_RESULTS = 'REQUEST_ERROR_EVENTS_SEARCH_RESULTS'
export const RECEIVE_ERROR_EVENTS_SEARCH_RESULTS = 'RECEIVE_ERROR_EVENTS_SEARCH_RESULTS'
export const REQUEST_ERROR_EVENTS_SEARCH_RESULTS_FAILED = 'REQUEST_ERROR_EVENTS_SEARCH_RESULTS_FAILED'
export const LOAD_MORE_ERROR_EVENTS_SEARCH_RESULTS = 'LOAD_MORE_ERROR_EVENTS_SEARCH_RESULTS'
export const TRIGGER_ERROR_EVENTS_SEARCH = 'TRIGGER_ERROR_EVENTS_SEARCH'
